...
class TopicDetector:
    ...
    def __call__(self, text: str, org_topics: Iterable[str]) -> TopicDetectorResult:
        """
        ...
        response: str = self.model.generate_content(
            self.wrap_text(text, org_topics)
        ).lower()
    ...
    def wrap_text(self, text: str, org_topics: Iterable[str]) -> str:
        return (
