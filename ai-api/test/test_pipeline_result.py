...
class TestPipelineResult(unittest.TestCase):
    def test_append(self):
        ...
        pipeline_result.append(FeedbackResult(True, ("topic1",)))
        pipeline_result.append(FeedbackResult(False, ("topic2",)))

        self.assertEqual(pipeline_result.items[0], FeedbackResult(True, ("topic1",)))
    ...
    def test_extend_same_topics(self):
        ...
        pipeline_result1.append(FeedbackResult(True, ("topic1",)))
        pipeline_result2.append(FeedbackResult(False, ("topic2",)))
        pipeline_result1.extend(pipeline_result2)

        self.assertEqual(pipeline_result1.items[1], FeedbackResult(False, ("topic2",)))
    ...
    def text_extend_different_topics(self):
        ...
        pipeline_result1.append(FeedbackResult(True, ("topic2",)))
        pipeline_result2.append(FeedbackResult(False, ("topic3",)))
